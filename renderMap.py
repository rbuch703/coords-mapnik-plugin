...
ds = mapnik.Datasource(type='hello', path="/home/rbuchhol/Desktop/MapnikPlugin/data/road", geometryType="polygon")
...
s = mapnik.Style()
r = mapnik.Rule()
r.symbols.append(mapnik.PolygonSymbolizer(mapnik.Color('rgb(50%,75%,50%)'), 1))
r.max_scale = 136495; #=zoom level 12
s.rules.append(r)
...
m.zoom_to_box( mapnik.Box2d(12.8, 52.2,13, 52.4) )
